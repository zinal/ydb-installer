...
For design and behavior details, see `SPECIFICATION.md`, `SPECIFICATION_UI.md` (configuration-step and global UI requirements), and `ARCHITECTURE.md`. For contributor guidance, see `AGENTS.md`.
